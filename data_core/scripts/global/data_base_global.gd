...
func _ready() -> void:
	...
	_load_database("res://data_core/ability/", abilities, "ability_id")
	_load_database("res://data_core/pokemon/", pokemons, "species_id")
	_load_database("res://data_core/move/", moves, "move_id")
